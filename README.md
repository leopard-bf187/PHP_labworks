...
[Лабораторная работа №1: Анализ HTTP запросов](https://github.com/leopard-bf187/PHP_labworks/tree/Lab1)
```bash
...
```
__Дата завершения:__ 25.02.2026
...
```
__Дата завершения:__ 05.03.2026
