...
Метод GET используется, потому что поисковая система запрашивает данные сервера, не изменяя их.
...
При загрузке страницы https://github.com используется метод GET\ и возвращен статус 200 OK.
